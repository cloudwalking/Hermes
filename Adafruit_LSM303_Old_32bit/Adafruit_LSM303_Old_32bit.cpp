...
/***************************************************************************
 PUBLIC FUNCTIONS
 ***************************************************************************/
void Adafruit_LSM303_Old_32bit::read()
{
...
void Adafruit_LSM303_Old_32bit::setMagGain(lsm303MagGain gain)
{
...
/***************************************************************************
 PRIVATE FUNCTIONS
 ***************************************************************************/
void Adafruit_LSM303_Old_32bit::write8(byte address, byte reg, byte value)
{
...
byte Adafruit_LSM303_Old_32bit::read8(byte address, byte reg)
{
  byte value;
